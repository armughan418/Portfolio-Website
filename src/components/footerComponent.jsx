            ...
            <footer class=" w-full flex items-center justify-center bg-gradient-to-r from-[#1a0024] via-[#320979] to-[#240066] ">
                <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                    <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                        <img className="w-10 h-10 rounded-full bg-yellow-500" alt="logo" src="images/logo1.png" />
                        <span class="ml-3 text-xl font-bold text-white">Armughan's Portfolio</span>
                    </a>
