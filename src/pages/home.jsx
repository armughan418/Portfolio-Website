...
const StyledWrapper = styled.div`
  ...
  .card {
    ...
    box-shadow: rgba(26, 0, 36, 0.3) 40px 50px 25px -40px, rgba(50, 9, 121, 0.2) 0px 25px 25px -5px;
    position: relative;
  }
  ...
  .circle1 { width: clamp(140px, 45vw, 160px); top: 8px; right: 8px; transform: translate3d(0, 0, 20px); }
  .circle2 { width: clamp(110px, 35vw, 130px); top: 10px; right: 10px; transform: translate3d(0, 0, 40px); transition-delay: 0.4s; }
  .circle3 { width: clamp(90px, 28vw, 100px); top: 17px; right: 17px; transform: translate3d(0, 0, 60px); transition-delay: 0.8s; }
  .circle4 { width: clamp(60px, 20vw, 70px); top: 23px; right: 23px; transform: translate3d(0, 0, 80px); transition-delay: 1.2s; }
  .circle5 {
  ...
  .parent:hover .card {
    ...
    box-shadow: rgba(26, 0, 36, 0.3) 30px 50px 25px -40px, rgba(50, 9, 121, 0.1) 0px 25px 30px 0px;
  }
  ...
  @media (max-width: 480px) {
    ...
    .circle1 { width: clamp(100px, 40vw, 120px); }
    .circle2 { width: clamp(80px, 32vw, 90px); }
    .circle3 { width: clamp(60px, 24vw, 70px); }
    .circle4 { width: clamp(40px, 16vw, 50px); }
    .circle5 { width: clamp(30px, 12vw, 35px); }
  }
`;
...
function Home() {
    ...
    const tools = [
        { imageURL: "../images/html.png", altText: "HTML", title: "HTML", type: "web" },
        { imageURL: "../images/css.webp", altText: "CSS", title: "CSS", type: "web" },
        { imageURL: "../images/js.png", altText: "JS", title: "JavaScript", type: "web" },
        { imageURL: "../images/react.png", altText: "ReactJS", title: "React JS", type: "web" },
        { imageURL: "../images/node.png", altText: "NodeJS", title: "Node JS", type: "web" },
        { imageURL: "../images/expressJS.png", altText: "ExpressJS", title: "Express JS", type: "web" },
        { imageURL: "../images/thumb.webp", altText: "Tailwind", title: "Tailwind CSS", type: "web" },
        { imageURL: "../images/Bootstrap_logo.svg.png", altText: "Bootstrap", title: "Bootstrap", type: "web" },
        { imageURL: "../images/c.webp", altText: "C", title: "C Language", type: "others" },
        { imageURL: "../images/cpp.png", altText: "C++", title: "C++", type: "others" },
        { imageURL: "../images/java.png", altText: "JAVA", title: "JAVA", type: "others" },
        { imageURL: "../images/mongoDB.webp", altText: "MongoDB", title: "MongoDB", type: "web" },
        { imageURL: "../images/mysql.png", altText: "MySQL", title: "MySQL", type: "web" },
    ];

    const myAcadamics = [
        { logo: "../images/ucp.jpg", title: "BSSE", subtitle: "Bachelor of Science Software Engineering", institute: "University of Central Punjab", status: "Ongoing", date: "2023 -2027" },
        { logo: "../images/pgc.png", title: "ICS", subtitle: "Intermediate of Computer Science", institute: "Punjab College, (Main)", status: "Completed", date: "2021 -2023" },
        { logo: "../images/fgs.jpeg", title: "Matric", subtitle: "Matric (Computer Science)", institute: "Freedom Grammar School", status: "Completed", date: "2019 -2021" },
        { logo: "../images/ideo.png", title: "Course", subtitle: "Website Development", institute: "Ideoversity Training Institute", status: "Completed", date: "2024 -2025" },
        { logo: "../images/navttc.jpg", title: "Course", subtitle: "Website Development",institute: "National Vocational & Technical Training Commission", Status: "Completed", date: "2025" },
    ];

    const projects = [
        { image: "./images/eps.jpg", title: "School Management System", discription: "A School Management System for managing student records and generating challan forms, with features to track and update fee payments.", hash1: "#react", hash2: "#tailwind", hash3: "#mongoDB", hash4: "#express", openLink: "https://github.com/armughan418/EPS-MY_SMS" },
        { image: "./images/ecommerce.png", title: "Ecommerce System", discription: "An Ecommerce system for menaging restraunt. A full CRUD is implemented in it with an admin dashboard also", hash1: "#react", hash2: "#react-bootstrap", hash3: "#mongoDB", hash4: "#express", openLink: "http://github.com/" }
    ];
    ...
    const handleMouseMove = (e) => {
        ...
        gradient.style.background = `radial-gradient(circle at ${x}px ${y}px, rgba(59,130,246,0.4), transparent 60%)`;
    };
    ...
    return (
        <>
                ...
                >
                    ...
                    >
                        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4">
                            ...
                            <br />
                            <span className="border-r-2 border-white pr-1">{currentText}</span>
                        </h1>
                        <p className="mb-8 leading-relaxed text-base sm:text-lg max-w-md">
                            I'm a Full-Stack Web Developer (MERN Stack). <br />Reach out if you'd like to learn more!
                        </p>
                        <motion.div
                        ...
                        >
                            ...
                            <button
                                onClick={() => window.open("https://github.com/armughan418/", "_blank")}
                        ...
                        <div className="mt-11">
                            <span class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center items-center sm:justify-start gap-7 ml-14">
                                <button
                                    onClick={() => window.open("https://www.linkedin.com/in/armughan-9a07a32b6/", "_blank")}
                                ...
                                <button onClick={() => window.open("https://github.com/armughan418/", "_blank")}
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                                ...
                                <a
                                    href="mailto:armughanjaved418@gmail.com"
                                    className="group flex justify-center items-center p-2 rounded-md drop-shadow-xl bg-[#EA4335] text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:bg-[#D93025] relative"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                                        <path d="M12 12.713l11.985-9.713H.015L12 12.713zm0 2.574L.015 6.999V20h23.97V6.999L12 15.287z" />
                                    </svg>
                                    <span className="absolute opacity-0 group-hover:opacity-100 group-hover:text-white group-hover:text-sm group-hover:-translate-y-10 duration-700">
                                        Email
                                    </span>
                                ...
                                <a href="https://wa.me/+923418609973" target="_blank" rel="noopener noreferrer"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1.1em" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" className="w-5 h-5">
                    ...
                    >
                        <div className="w-56 h-56 sm:w-64 sm:h-64 lg:w-80 lg:h-80 bg-yellow-500 rounded-full overflow-hidden shadow-lg flex items-center justify-center">
                            <img
            ...
            >
                ...
                >
                    ...
                    >
                        <img src="./images/my-photo2.png" alt="Armughan" className="w-full h-full object-cover object-center" />
                    </motion.div>
                    ...
                    >
                        <h1 className="font-bold text-3xl sm:text-4xl lg:text-5xl text-yellow-500">About Me</h1>
                        <motion.div
                            initial={{ width: 0 }}
                        ...
                        <p className="text-base sm:text-lg leading-relaxed max-w-2xl">
                            I am Armughan, currently in the 4th semester of a Bachelor of Science in Software Engineering (BSSE) at the University of Central Punjab (UCP), Lahore. Alongside my degree, I have completed a Website Development course at Ideoversity Training Institute, located in Arfa Karim Software Technology Park, Lahore. Currently, I am also doing a web development internship under the NAVTTC program.
                        </p>
                        <p className="text-base sm:text-lg leading-relaxed max-w-2xl">
            ...
            {/* Academics Section */}
            <div id="acadamics" className="min-h-screen bg-gradient-to-r from-[#1a0024] via-[#320979] to-[#240066] py-12 pt-28">
                <div className="relative flex flex-col items-center text-white px-4">
                    <h1 className="text-yellow-500 text-3xl sm:text-4xl font-bold tracking-wide">Academics</h1>
                ...
                <div className="flex flex-wrap gap-14 justify-center pt-11 px-4">
                    <StyledWrapper className="w-full max-w-7xl flex flex-wrap gap-8 justify-center">
                        {myAcadamics.map((item, index) => (
                            <div key={index} className="opacity-0 animate-fadeInUp animation-delay-200 shadow parent cursor-pointer w-full sm:w-[20rem] md:w-[22rem]">
                                <div className="p-2 card w-full h-full transform transition-transform duration-300 hover:scale-105">
                                    ...
                                    <div className="content text-white px-4 py-2 space-y-1">
                                        <span className="title block text-lg font-semibold">{item.title}</span>
                                        <span className="text block text-sm w-44">{item.subtitle}</span>
                                        <span className="text block text-sm w-44">{item.date}</span>
                                    </div>
                                    <div className="bottom px-4 py-2">
                                        <div className="social-buttons-container">
                                            <h1 className="font-bold text-sm sm:text-base text-yellow-500">{item.institute}</h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="tools" className="bg-gradient-to-r from-[#1a0024] via-[#320979] to-[#240066] min-h-screen px-4 py-12 pt-24">
                <div className="text-center">
                    <h1 className="text-yellow-500 text-3xl sm:text-4xl font-bold">Tools & Technologies</h1>
        ...
        ${selectedType === "others"
            ...
            {/* Projects Section */}
            <div id="projects" className="min-h-screen w-full bg-gradient-to-r from-[#1a0024] via-[#320979] to-[#240066] text-white flex flex-col items-center px-6 py-16">
                {/* Title */}
                <div className="text-center mb-12">
                    <h1 className="text-yellow-400 text-2xl sm:text-4xl font-bold tracking-wide">My Projects</h1>
                ...
                <div className="flex flex-wrap justify-center gap-10">
                    {projects.map((project, index) => (
                        <div
                            ...
                            style={{ transition: 'transform 0.3s ease' }} // ensures smooth scaling
                        >
                            {/* Image */}
                            <img
                                src={project.image}
                            ...
                            <div className="flex flex-col gap-3">
                                <p className="text-yellow-400 text-xl font-bold">{project.title}</p>
                                <p className="text-neutral-300 text-sm sm:text-base">{project.discription}</p>
                            </div>
                ...
                <section className="relative flex items-center justify-center min-h-screen bg-gradient-to-r from-[#1a0024] via-[#320979] to-[#240066] text-white px-5">
                    <div className="container mx-auto py-16">
                        <div className="flex flex-col text-center w-full">
                            <h1 className="text-4xl sm:text-3xl font-bold text-yellow-500 mb-4">Contact Me</h1>
                            ...
                            <p className="lg:w-2/3 mx-auto text-base leading-relaxed text-white mb-6">
                                If you have any questions or if you want to get in touch, feel free to reach out! I would love to hear from you.
                            </p>
                        </div>

                        <form ref={form} onSubmit={sendEmail} className="max-w-2xl mx-auto bg-white bg-opacity-10 backdrop-blur-md p-8 rounded-lg shadow-lg">
                            <div className="flex flex-col md:flex-row md:space-x-4">
                                <div className="flex-1 mb-4">
                                    <label className="block mb-2 text-sm font-semibold text-yellow-400">Name</label>
                                    <input
                                        required
                                        type="text"
                                        name="name"
                                ...
                                <div className="flex-1 mb-4">
                                    <label className="block mb-2 text-sm font-semibold text-yellow-400">Email</label>
                                    <input
                                        required
                                        type="email"
                                        name="email"
                            ...
                            <div className="mb-4">
                                <label className="block mb-2 text-sm font-semibold text-yellow-400">Message</label>
                                <textarea
                                    required
                                    name="message"
                                    autoComplete="off"
